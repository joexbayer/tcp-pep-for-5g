...
Congestion occours in the internet when a network's resources, such as routers, are overloaded to the point that they diminish quality of the network. Packet loss and high delays are common issues acsociated to high congestion in the network. To solve the problem of congestion, a distributed algoirthm is used: Congestion Control. The main goals of congestion control is to maintain a stable network, while still utilizing the avaiable bandwidth shared among other flows.
