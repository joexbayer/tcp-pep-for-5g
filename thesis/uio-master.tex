...
I would like to acknowledge and thank my supervisor Micheal Welzl for motivating me throughout my thesis and always being available for feedback and discussions. And my co-supervisor Kristjon Ciko for helping me navigate the enormous Linux kernel and restarting the testbed machines when I inevitably would crash them.\\

I would also like to thank my friends, co-workers and family for keeping my spirits high. Additionally, I would like to thank my work place for being understanding and giving me time and resources for my thesis. At last I want to my thank my wonderful girlfriend for motivating me and helping me proofread hundreds of pages.

\chapter*{Declaration of the use of generative artificial intelligence}
In this thesis, generative artificial intelligence (AI) has been used for brainstorming and as a assisting tool in the development. The service ChatGPT-4, developed by OpenAI, has been used to brainstorm ideas surrounding the thesis and during the writing, and discuss issues in the development phase. Additionally, Github Copilot was used under the development phase of the PEP and when creating tools and scripts to visualize data from the evaluation.
...
\begin{figure}[ht]
  \centering
  \subfloat[Throughput for 10 flows with BFIFO (Jain's fairness index 0.8827)]{
  	\includegraphics[width=0.40\textwidth]{
  		../diagrams/witestlab/throughput/10flows/BFIFO.pdf
  	}
  	\label{fig:subfig1}}
  \hfill
  \subfloat[Throughput for 10 flows with FQ-CoDel (Jain's fairness index 0.9694)]{
  	\includegraphics[width=0.40\textwidth]{
  		../diagrams/witestlab/throughput/10flows/FQ-CoDel.pdf
  	}
  	\label{fig:subfig2}}
  \hfill
  \subfloat[Throughput for 10 flows with PEP (Jain's fairness index 1.0000)]{
  	\includegraphics[width=0.40\textwidth]{
