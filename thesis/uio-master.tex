...
Since we do not have a "main" thread for each connection, and we want to avoid "global" variables, we do not have a stack state, all events are "async" and will not have access to our PEP states as we only get sock structs.\\
