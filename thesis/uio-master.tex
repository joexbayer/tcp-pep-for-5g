...
The PEP TLVs are implemented as a shared library which is both used by the PEP itself and applications. The applications will use the library to create TLVs connecting to the PEP, while the PEP uses the library to validate and read the TLV options. 
