...
Throughput of PEP, high std for BFIFO, low throughput for FQ-CoDel, the essential esscence for the PEP.
High reaction times to fluctuating bandwidth.
...
Latency, show still no impact of the PEP, while BFIFO creates huge queues. almost 3 times the throughput for FQ-CoDel.
