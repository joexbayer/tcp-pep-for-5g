...
\begin{figure}[h!] % htbp stand for "here", "top", "bottom", "page"
	...
	\includegraphics[scale=0.33]{../diagrams/witestlab/lb_mobb.png}
  	\caption{Capacity fluctuations from mmwave, witestlab.}
  	\label{fig:blockage}
\end{figure}
...
Figure \ref{fig:witestlab_graph_delay} shows the results of the latency measurements. Comparing our results to the Witestlab experiment we  can see that the shapes of the graphs are the same. However the magnitude of the latency spikes are quite different different between our and their experiments. This may be the result of our hardware or more modern Linux kernel. 
