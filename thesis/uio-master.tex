...
This is another choice which will bind us to Linux, as achieving the same control and configuration on other operating system, such as Windows or MacOS, will be extremely difficult or even impossible. The impact of different scheduling algorithms will be shown and discussed in the Evaluation chapter.\footnote{Talk more about FQ\_CoDEl, BFIFO, Maybe TFO? etc}
...
The most important difference is the large buffers on our PEP, although other PEPs also have larger than default buffers, our PEP has the largest configurable buffers, up to 2GB.
