...
%The static link has a steady capacity with only a few fluctuations.
...
%Condition & Mean & Std Dev & Median & Min & Max \\
%\midrule
%With PEP & 41.09s & 10.60s & 36.30s & 33.52s & 66.86s\\
%Without PEP & 98.53s & 8.63s & 100.72s & 85.85s & 107.93s\\
%
%\bottomrule
%\end{tabularx}
%\caption{Short blockage flow completion time statistics}
%\label{tab:sb_fct_statistics}
%\end{table}
