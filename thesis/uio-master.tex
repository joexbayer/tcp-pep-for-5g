...
\definecolor{codeblue}{rgb}{0.07, 0.04, 0.56}
...
\section{PEP Connect}
Since our PEP is explicitly addressed we need to change how we connect on the client side.
