...
\paragraph{Bandwidth utilization}
Better bandwidth utilization when splititnf connections.\\
[PICTURE]
...
\paragraph{Failure fallback}
If TCP fast Open isnt supported / doesnt work.
