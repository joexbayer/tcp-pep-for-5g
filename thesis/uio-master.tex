...
<picture>\\
\\
The Testbed consists of four hosts, the first is the controller from which we orchestrate the experiment. The last 3 represent the sender, router and receiver. 
...
\begin{verbatim}
  ...
  `d$$'     ,$P"'   .    $$$     Shell: bash 5.1.4
   ...
   $$\;      Y$b._   _,d$P'      GPU: Matrox Electronics Systems Ltd. G200eR2 (rev 01)
...
Sender ---(100Mbit/s, 100ms)--- Router ---(15mbit/s - 70mbit/s, 20ms)--- Receiver\\

\subsubsection{Sender}
100mbit sending rate.
...
The interactive traffic is simulated by ULTRA\_PING, it is configured to send 20 packets per second with 100bytes each. This is done to mimic Skype traffic.\\

The experiment consists of 3 steps:\\

\subsubsection{Step 1}
In the first step we start ULTRA\_PING from the sender to the receiver and wait 5 seconds to get a baseline.
\subsubsection{Step 2}
The second step consists of starting the file transfer.
\subsubsection{Step 3}
After 13 seconds we change the bandwidth between the router and the receiver, simulating fluctuating bandwidth.

\section{Results \& Analysis}

\begin{figure}[h!] % htbp stand for "here", "top", "bottom", "page"
	\centering
	\includegraphics[scale=0.60]{../diagrams/graphs/final.pdf}
